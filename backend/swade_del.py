...
def insert_products(products):
    ...
    for product in products:
        ...
        if product['Dispensary'] == 'SWADE Dispensary Delmar':
            cursor.execute("""
...
if response.status_code == 200:
    ...
    for product in products:
        ...
        new_products.append({
            ...
            'Dispensary': 'SWADE Dispensary Delmar',
            'Image': product['Image'],
            'sales': sales_data

        })

delete_old_products('SWADE Dispensary Delmar')
