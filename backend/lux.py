...
def insert_products(products):
    ...
    for product in products:
        ...
        if product['Dispensary'] == 'Luxury Leaf Marijuana Dispensary':
                  cursor.execute("""
...
if response.status_code == 200:
    ...
    for product in products:
        ...
        new_products.append({
            ...
            'Dispensary': 'Luxury Leaf Marijuana Dispensary',
            'Image': product['Image'],
            'sales': sales_data
        })
...
delete_old_products('Luxury Leaf Marijuana Dispensary')
