...
def insert_products(products):
    ...
    for product in products:
        ...
        if product['Dispensary'] == 'GreenLight Dispensary':
            cursor.execute("""
...
# URL
url = "https://dutchie.com/graphql?operationName=FilteredProducts&variables=%7B%22includeEnterpriseSpecials%22%3Afalse%2C%22includeCannabinoids%22%3Atrue%2C%22productsFilter%22%3A%7B%22dispensaryId%22%3A%225eed1ec7c1d99800c5ba0e65%22%2C%22pricingType%22%3A%22rec%22%2C%22strainTypes%22%3A%5B%5D%2C%22subcategories%22%3A%5B%5D%2C%22Status%22%3A%22Active%22%2C%22types%22%3A%5B%22Topicals%22%5D%2C%22useCache%22%3Afalse%2C%22sortDirection%22%3A1%2C%22sortBy%22%3A%22brand%22%2C%22isDefaultSort%22%3Atrue%2C%22bypassOnlineThresholds%22%3Afalse%2C%22isKioskMenu%22%3Afalse%2C%22removeProductsBelowOptionThresholds%22%3Atrue%7D%2C%22page%22%3A0%2C%22perPage%22%3A50%7D&extensions=%7B%22persistedQuery%22%3A%7B%22version%22%3A1%2C%22sha256Hash%22%3A%229395f892cb5a4c5dd2a03401304c637b084a0d0a7385b126630df54f656daf76%22%7D%7D"

headers = {
    'Accept': '*/*',
    'Content-Type': 'application/json',
    'Referer': 'https://dutchie.com/embedded-menu/greenlight-dispensary-berkely/products/topicals?_ga=2.70595792.1512036709.1715491125-491121544.1713400678',
...
if response.status_code == 200:
    ...
    for product in products:
        ...
        new_products.append({
            ...
            'Dispensary': 'GreenLight Dispensary',
            'Image': product['Image'],
            'sales': sales_data

        })

delete_old_products('GreenLight Dispensary')
